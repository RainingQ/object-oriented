...
{
	double num1;		//用于存放被加数、被减数、被乘数、被除数
	double num2;		//用于存放加数、减数、乘数、除数
	double tempNum;		//用于存放由于优先级较小，需暂时先弹出的值，以及压栈时的临时变量 
	string tempOper;	//用于存放由于优先级较小，需暂时先弹出的运算符，以及压栈时的临时变量 
